...
@State(Scope.Thread)
public class FileValidatorLargeMimeNoHashBench {
    ...
    public void fileValidatorSmallBench() throws RunnerException {
        ...
        .include(FileValidatorLargeMimeNoHashBench.class.getSimpleName())
        .forks(2)
        .mode(Mode.All)
        ...
        for(RunResult runResult : runResults) {
            switch(i) {
                case 0:
                contentToAppend = "Mime Large File No Checksum Throughput Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ci" + System.lineSeparator();
                    break;
                case 1:
                contentToAppend = "Mime Large File No Checksum Average Time Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 2:
                contentToAppend = "Mime Large File No Checksum Sample Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 3:
                contentToAppend = "Mime Large File No Checksum Single Shot Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                default:
                contentToAppend = "Mime Large File No Checksum Unknown Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore() + " ms" + System.lineSeparator());
                    break;
            }
