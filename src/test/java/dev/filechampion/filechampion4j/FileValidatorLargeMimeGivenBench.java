...
@State(Scope.Thread)
public class FileValidatorLargeMimeGivenBench {
    ...
    public void fileValidatorSmallBench() throws RunnerException {
        ...
        .include(FileValidatorLargeMimeGivenBench.class.getSimpleName())
        .forks(1)
        .mode(Mode.All)
        ...
        for(RunResult runResult : runResults) {
            switch(i) {
                case 0:
                contentToAppend = "Mime Given Large File Throughput Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ci" + System.lineSeparator();
                    break;
                case 1:
                contentToAppend = "Mime Given Large File Average Time Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 2:
                contentToAppend = "Mime Given Large File Sample Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 3:
                contentToAppend = "Mime Given Large File Single Shot Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                default:
                contentToAppend = "Mime Given Large File Unknown Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore() + " ms" + System.lineSeparator());
                    break;
            }
