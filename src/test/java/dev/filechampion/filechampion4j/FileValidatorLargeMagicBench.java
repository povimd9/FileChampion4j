...
@State(Scope.Thread)
public class FileValidatorLargeMagicBench {
    ...
    public void fileValidatorSmallBench() throws RunnerException {
        ...
        .include(FileValidatorLargeMagicBench.class.getSimpleName())
        .forks(1)
        .mode(Mode.All)
        ...
        for(RunResult runResult : runResults) {
            switch(i) {
                case 0:
                contentToAppend = "Magic Large File Throughput Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ci" + System.lineSeparator();
                    break;
                case 1:
                contentToAppend = "Magic Large File Average Time Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 2:
                contentToAppend = "Magic Large File Sample Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 3:
                contentToAppend = "Magic Large File Single Shot Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                default:
                contentToAppend = "Magic Large File Unknown Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore() + " ms" + System.lineSeparator());
                    break;
            }
