...
@State(Scope.Thread)
public class FileValidatorLargeMimeBench {
    ...
    public void fileValidatorSmallBench() throws RunnerException {
        ...
        .include(FileValidatorLargeMimeBench.class.getSimpleName())
        .forks(1)
        .mode(Mode.All)
        ...
        for(RunResult runResult : runResults) {
            switch(i) {
                case 0:
                contentToAppend = "Mime Large File Throughput Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ci" + System.lineSeparator();
                    break;
                case 1:
                contentToAppend = "Mime Large File Average Time Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 2:
                contentToAppend = "Mime Large File Sample Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                case 3:
                contentToAppend = "Mime Large File Single Shot Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore()) + " ms" + System.lineSeparator();
                    break;
                default:
                contentToAppend = "Mime Large File Unknown Bench, " + String.format("%.6f",runResult.getPrimaryResult().getScore() + " ms" + System.lineSeparator());
                    break;
            }
